  ...
  <section class="section event" id="event" aria-label="event">
    <div class="container">
      ...
      <section class="event-section">
        <div class="event-box">
          <img src="./public/images/Competitions 2011A/20110808b_007105002_eenadu.jpg" alt="Event 1"/>
        ...
        <div class="event-box">
          <img src="./public/images/Competitions 2012A/D25772974.JPG" alt="Event 2"/>
          <div class="event-info">
            <h3>Event 2</h3>
            <p>Competition:2</p>
            <p>Year: 2012</p>
        ...
        <div class="event-box">
          <img src="./public/images/Competitions 2018/PrajaaSakthi.jpg" alt="Event 3"/>
          <div class="event-info">
            <h3>Event 3</h3>
            <p>Competition:3</p>
                        <p>Year: 2016</p>
        ...
        <div class="event-box">
          <img src="./public/images/Competitions 2023/Sakshi 01-05-2023 Competition 2023.jpg" alt="Event 3"/>
          <div class="event-info">
            <h3>Event 3</h3>
            <p>Competition:4</p>
                        <p>Year: 2018</p>
        ...
        <div class="event-box">
          <img src="./public/images/Competitions 2023/Andhra Jyothi 01-05-2023 Competition 2023.jpg" alt="Event 3"/>
          <div class="event-info">
            <h3>Event 3</h3>
            <p>Competition:5</p>
                        <p>Year: 2023</p>
